...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0xFFFFFFFF, 0xAAFFFFFF,
			0x77FFFFFF };
	// Draw Shadows
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.wheel_background_center;
	private int wheelForeground = R.drawable.wheel_foreground;
	...
	private int calculateLayoutWidth(int widthSize, int mode) {
		...
		// TODO: make it static
		itemsLayout.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
