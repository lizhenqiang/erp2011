...
/**
 * Columns for the {@code pm_work_item} table.
 */
public class PmWorkItemColumns implements BaseColumns {
    public static final String TABLE_NAME = "pm_work_item";
    ...
    public static boolean hasColumns(String[] projection) {
        ...
        for (String c : projection) {
            ...
            if (c.equals(PACKAGE_DESCRIPTION) || c.contains("." + PACKAGE_DESCRIPTION)) return true;
